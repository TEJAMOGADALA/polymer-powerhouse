...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Polymer Document Management System" },
      { name: "description", content: "Digital Delivery Challan & Tax Invoice management for polymer manufacturing companies." },
      { property: "og:title", content: "Polymer Document Management System" },
